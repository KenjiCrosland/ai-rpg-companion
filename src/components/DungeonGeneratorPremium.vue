      ...
      <template #label>
        <div class="accordion-lineup">
          ...
          <cdr-tooltip id="tooltip-example" position="right">
            <template #trigger>
              <cdr-button size="small" :icon-only="true" :with-background="true" @click.stop="generateRoomList">
                <template #icon>
                  <icon-reload />
                </template>
              </cdr-button>
      ...
      <cdr-accordion-group id="detailed-rooms">
        <cdr-accordion v-for="(room, index) in detailedRooms" :key="`detailed-room-${index}`" level="2"
          ...
          <cdr-tooltip id="tooltip-example" position="left" class="delete-button">
            <template #trigger>
              <cdr-button size="small" :icon-only="true" :with-background="true" @click.stop="deleteRoom(index)">
                <template #icon>
                  <icon-x-sm />
                </template>
              </cdr-button>
