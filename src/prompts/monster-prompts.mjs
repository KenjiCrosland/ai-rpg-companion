...
const baseCreatureTemplate = {
  name: 'CREATURE_NAME',
  type_and_alignment: 'SIZE CREATURE_TYPE, ALIGNMENT',
  ...
  saving_throws:
    'STR +14, CON +12 (These should always be higher than attribute bonuses)',
  skills: 'Stealth +8',
...
export function createStatblockPrompts(options) {
  ...
  // Prevent empty name from producing template example creature
  // Instead, encourage a creative, unconventional creature
  if (!monsterName || monsterName.trim() === '') {
    const creativePrompts = [
      // Biological horror
      'Parasitic organism',
      'Colonial swarm intelligence',
      'Fungal horror',
      'Predatory plant',
      'Deep-sea abomination adapted to land',
      'Symbiotic hive creature',
      'Sentient ooze',
      'Burrowing ambush predator',
      'Spore carrier',
      'Venomous mimic',
      'Bone-grafting scavenger',
      'Molt-shedding regenerator',
      'Bioluminescent lure predator',
      'Egg-clutch guardian',
      'Carrion bloomer',
      'Tidal pool nightmare',
      'Coral reef predator',
      'Pheromone manipulator',
      'Saliva-webbing trapper',
      'Skin-shedding infiltrator',
      'Echolocation hunter',
      'Blood-drinking swarm',
      'Throat-singing hypnotist',
      'Ink-cloud ambusher',
      'Camouflage apex predator',
      'Thermal vent organism',
      'Pressure-adapted deep dweller',
      'Toxin-secreting amphibian horror',
      // Cursed and tragic
      'Cursed automaton',
      'Feral familiar',
      'Animated remains',
      'Cursed artisan',
      'Abandoned construct',
      'Grief-animated object',
      'Monstrous familiar',
      'Warped mundane animal',
      'Petrified creature reawakened',
      'Betrayed guardian spirit',
      'Oath-broken paladin remnant',
      'Fossilized predator revived',
      'Mirror-trapped duplicate',
      'Portrait that escaped its frame',
      'Lullaby given malevolent form',
      'Wedding curse manifestation',
      'Drowned sailor returned wrong',
      'Harvest scarecrow awakened',
      'Beloved toy grown monstrous',
      'Executioners guilt made flesh',
      'Forgotten prayer turned feral',
      'Shipwreck barnacle colony with memories',
      'Taxidermy animal reanimated incorrectly',
      'Sundial shadow that detached at noon',
      // Arcane and planar
      'Mechanimagical aberration',
      'Abyssal servant',
      'Infernal soldier',
      'Feywild exile',
      'Shadowfell remnant',
      ...
      'Ethereal stalker',
      'Far Realm intruder',
      'Vestige of a dead god',
      'Wild magic mutation',
      'Phase-shifting hunter',
      'Magic-eating scavenger',
      'Dream predator',
      'Spell scar entity',
      'Living antimagic field',
      'Rogue summoning gone wrong',
      'Arcane battery overloaded',
      'Sentient ward system',
      'Ley line tumor',
      'Teleportation accident survivor',
      'Condensed planar bleed',
      'Cantrip loop given form',
      'Wizards failed thesis project',
      'Potion spill that gained sentience',
      'Scroll that consumed its reader',
      'Familiar that outlived its master by centuries',
      'Demiplane collapsed into a creature',
      // Cultural mythology
      'Creature from Slavic folklore',
      'Creature from Japanese yokai traditions',
      'Creature from West African folklore',
      'Creature from Polynesian mythology',
      'Creature from Mesoamerican mythology',
      'Creature from Hindu mythology',
      'Creature from Inuit mythology',
      'Creature from Filipino folklore',
      'Creature from Aboriginal dreamtime',
      'Creature from Persian mythology',
      'Creature from Korean folklore',
      'Creature from Mongolian steppe legends',
      'Creature from Haitian vodou traditions',
      'Creature from Finnish Kalevala mythology',
      'Creature from Amazonian jungle folklore',
      'Creature from Tibetan Buddhist demonology',
      'Creature from Maori traditions',
      'Creature from Egyptian mythology that is not a mummy',
      'Creature from Celtic folklore that is not a fey',
      'Creature from Mesopotamian mythology',
      ...
      'Storm-born predator',
      'Glacier parasite',
      'Volcanic vent guardian',
      'Whirlpool entity',
      'Dust devil with hunger',
      'Petrified forest awakening',
      'Coral golem',
      'Salt flat crystalline stalker',
      'Fog bank with teeth',
      'Peat bog digester',
      'Magnetized ore swarm',
      'Calcified geyser sentinel',
      // Mundane gone wrong
      'Weaponized vermin',
      'Tavern rat king grown enormous',
      'Flock of birds sharing one mind',
      'House cat with unnatural intelligence',
      'Rooster warped by wild magic',
      'Beehive with a vendetta',
      'Scarecrow that learned to walk',
      'Well that learned to swallow',
      'Compost heap with ambition',
      'Root cellar that digests visitors',
      'Windmill grinding bones instead of grain',
      'Garden hedge grown predatory',
      'Cobblestone road that rearranges itself',
      'Fishing net that catches people',
      'Weather vane that summons what it points at',
      // Sound and perception
      'Sound-based predator',
      'Memory thief',
      'Silence that hunts',
      'Echo that diverged from its source',
      'Shadow that ate its owner',
      'Smell that coalesced into a body',
      'Color that drains from surroundings',
      'Melody that nests in the skull',
      'Afterimage left by a dead god',
      'Reflection that steps out of water',
      'Footprint trail that follows you back',
      'Temperature drop given predatory instinct',
    ];
    const pick =
      creativePrompts[Math.floor(Math.random() * creativePrompts.length)];
    monsterName = `a CR ${challengeRating} creature: ${pick}`;
  }
