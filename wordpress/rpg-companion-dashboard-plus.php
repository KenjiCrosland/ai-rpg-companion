 ...
 *
 * Template Name: RPG Companion Dashboard Plus
 *
 * @package Genesis Custom RPG Companion Dashboard Plus
 * @author  Your Name
...
function vue_app_enqueue_assets() {
    $vue_app_path = get_stylesheet_directory() . '/rpg-companion-dashboard-plus/dist/assets';
    $vue_app_url = get_stylesheet_directory_uri() . '/rpg-companion-dashboard-plus/dist/assets';
...
function vue_app_render_root_element() {
    echo '<div id="app" data-page="gm-dashboard-plus"></div>';
}
