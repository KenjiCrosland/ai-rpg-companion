 ...
 *
 * Template Name: RPG Companion Bookshelf Generator
 *
 * @package Genesis Custom RPG Companion Bookshelf Generator
 * @author  Your Name
...
function vue_app_enqueue_assets() {
    $vue_app_path = get_stylesheet_directory() . '/rpg-companion-book-generator/dist/assets';
    $vue_app_url = get_stylesheet_directory_uri() . '/rpg-companion-book-generator/dist/assets';
...
function vue_app_render_root_element() {
    echo '<div id="app" data-page="book-generator"></div>';
}
