 ...
 *
 * Template Name: RPG Companion Lore Generator
 *
 * @package Genesis Custom RPG Companion Lore Generator
 * @author  Your Name
...
function vue_app_enqueue_assets() {
    $vue_app_path = get_stylesheet_directory() . '/rpg-companion-lore-generator/dist/assets';
    $vue_app_url = get_stylesheet_directory_uri() . '/rpg-companion-lore-generator/dist/assets';
...
function vue_app_render_root_element() {
    echo '<div id="app" data-page="lore-generator"></div>';
}
