...
function vue_app_enqueue_assets() {
    $vue_app_path = get_stylesheet_directory() . '/rpg-companion-setting-generator/dist/assets';
    $vue_app_url = get_stylesheet_directory_uri() . '/rpg-companion-setting-generator/dist/assets';
