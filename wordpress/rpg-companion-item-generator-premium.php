 ...
 *
 * Template Name: RPG Companion Magic Item Generator Premium
 *
 * @package Genesis Custom RPG Companion Magic Item Generator Premium
 * @author  Your Name
...
function vue_app_enqueue_assets() {
    $vue_app_path = get_stylesheet_directory() . '/rpg-companion-item-generator-premium/dist/assets';
    $vue_app_url = get_stylesheet_directory_uri() . '/rpg-companion-item-generator-premium/dist/assets';
...
function vue_app_render_root_element() {
    echo '<div id="app" data-page="item-generator-premium"></div>';
}
