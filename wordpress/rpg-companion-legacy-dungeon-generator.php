 ...
 *
 * Template Name: RPG Companion Legacy Dungeon Generator
 *
 * @package Genesis Custom RPG Companion Legacy Dungeon Generator
 * @author  Your Name
...
function vue_app_render_root_element() {
    echo '<div id="app" data-page="legacy-dungeon-generator"></div>';
}
